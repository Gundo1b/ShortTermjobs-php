...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Short</b>TermJobs</span>
    </a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1>All <strong> ShortTermJobs</strong> In One Place</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 latest-job margin-bottom-20">
            <h1 class="text-center">Latest  ShortTermJobs</h1>            
            <?php 
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
              ...
              <div class="attachment-pushed">
                <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">R<?php echo $row['maximumsalary']; ?>/Month</span></h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Candidates</h1>
            <p>Finding a job just got easier. Create a profile and apply with single click.</p>            
          </div>
        </div>
        <div class="row">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2016-2017 <a href="learningfromscratch.online">ShortTermJobs</a>.</strong> All rights
    reserved.
    </div>
  </footer>
